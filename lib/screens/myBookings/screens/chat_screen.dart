...
import 'package:helperhive/screens/chats/widgets/chat_field.dart';
import 'package:helperhive/screens/chats/widgets/message_bubble.dart';
import 'package:provider/provider.dart';

class MessagesView extends StatefulWidget {
  final Function(bool)? onBack;
  final ServiceBooking selectedUser;
  // final String userId;
  const MessagesView({
    super.key,
